...
public class Card extends JButton{
	...
	private Permbajtja_letres cardData;
	private BufferedImage suitImge;
	private String lbl;
	
	int tableIndx = -1;
	//Fonti per krijimin e kartave
	private Font CARDS_FONT  = new Font("Arial",1,15);
	private int ROUND_RADIUS = 10;
	int EDGE_SHIFT = 1;
	
	public Card(Permbajtja_letres cardData) {
	...
	//Letrave me numer me madh se 10 u vihen shkronjat perkatese si J,Q,K 
	...
	public Permbajtja_letres getCardData() {
		return cardData;
	}
	...
	{	
		...
		//Body
		GradientPaint bodyGradient = new GradientPaint(200 - this.getWidth()/2,0, Color.white, 200- this.getWidth()/2, this.getHeight() + 250, Color.white);
