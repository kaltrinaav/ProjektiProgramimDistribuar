...
/**
 * 
 * @return Kthen numrin e lojtarit
 */
  ...
  /**
   * 
   * @param playerIndex Numri i lojtarit
   */
...
/**
 * 
 * @param playerName Emri i lojtarit
 */
	...
	public void AddScore(int Score) {
		this.Score += Score; //shton piket
	}

	public int getScore() {
		return this.Score; //kthen piket
	}
